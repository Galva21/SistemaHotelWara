...
{
    public partial class Anual : Form
    {
        ...
        private void Anual_Load(object sender, EventArgs e)
        {
            recargar(DateTime.Now.Year);
        }
        ...
        private void Top5HabitacionMensual(int mes)
        {
            ...
            cmd = new SqlCommand("Top5HabitacionAnual", conexion);
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        private void Top5PisoMensual(int mes)
        {
            ...
            cmd = new SqlCommand("Top5PisoAnual", conexion);
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        {
            decimal ingreso = 0;
            cmd = new SqlCommand("IngresoAnual", conexion);
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        {
            cmd = new SqlCommand("NroReservasAnual", conexion);
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        {
            cmd = new SqlCommand("NroReservasCanceladaAnual", conexion);
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        {
            recargar((int)(numericUpDown1.Value));
        }
    }
}
